...
import 'package:ugbussinesscard/resizable_utils/corner_button.dart';
...
const double kEdgeSnapPadding = 0;

/// The size of the [cornerButton] used for resizing.
const double kCornerButtonSize = 30.0;
    ...
    return widget.disabled || !initialized
        ...
        : Stack(
            ...
            children: <Widget>[
              ...
              Positioned(
                left: wrapperSize!.width - 5,
                top: wrapperSize!.height - 5,
              ...
              //       offset: const Offset((-kCornerButtonSize / 2) - 104,
